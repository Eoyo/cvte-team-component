...
//   }
// })(here, function($ : JQueryStatic, SimpleModule : any) {
//   var Uploader,
//     uploader,
...
//     };
//   })();
//   upload(file : FileList | File | File[] | undefined, opts: {
//     fileKey: string;
//   }) {
//     var f, i, key, len;
//     if (file == null) {
...
//           if (
//             this.queue.length > 0 &&
//             this.files.length < this.opts.connectionCount
//           ) {
...
//   var args = [key], ref, result : string;
